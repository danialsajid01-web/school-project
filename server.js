...
// Tables creation
db.serialize(() => {
  db.run(`CREATE TABLE IF NOT EXISTS students (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, roll_no TEXT, class TEXT, parent_name TEXT, phone TEXT, address TEXT )`);
  db.run(`CREATE TABLE IF NOT EXISTS teachers (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, subject TEXT, phone TEXT )`);
    ...
    db.get(`SELECT * FROM students WHERE id = ?`, [studentId], (err, student) => {
        ...
        db.all(`SELECT * FROM marks WHERE student_id = ?`, [studentId], (err, marks) => {
            db.all(`SELECT * FROM attendance WHERE student_id = ?`, [studentId], (err, attendance) => {
                db.all(`SELECT * FROM fees WHERE student_id = ?`, [studentId], (err, fees) => {
                    res.json({
                        student: student,
                        marks: marks || [],
